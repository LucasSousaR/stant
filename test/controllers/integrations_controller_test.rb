...
class IntegrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create integration" do
    assert_difference("Integration.count") do
      post integrations_url, params: { integration: { name: @integration.name, type_file: @integration.type_file } }
    end
  ...
  test "should update integration" do
    patch integration_url(@integration), params: { integration: { name: @integration.name, type_file: @integration.type_file } }
