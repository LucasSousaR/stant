...
class SpeechesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speech" do
    assert_difference("Speech.count") do
      post speeches_url, params: { speech: { duration: @speech.duration, name: @speech.name } }
    end
  ...
  test "should update speech" do
    patch speech_url(@speech), params: { speech: { duration: @speech.duration, name: @speech.name } }
